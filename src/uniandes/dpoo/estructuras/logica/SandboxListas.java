...
public class SandboxListas
{
    ...
    {
        int[] respuesta = listaEnteros.stream().mapToInt(Integer::intValue).toArray();
        return respuesta;
    }
    ...
    {
        int respuesta = listaEnteros.size();
        return respuesta;
    }
    ...
    {
    	int respuesta = listaCadenas.size();
        return respuesta;
    }
    ...
    {
    	listaEnteros.removeIf(elem -> elem.equals(valor));
    }
    ...
    {
    	listaCadenas.removeIf(elem -> elem.equals(cadena));
    }
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
    	...
    	{int respuesta = (int)Math.floor(valor);
    ...
    {
        int respuesta= Collections.frequency(listaEnteros, valor);
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        {repetidos.put(elemento, repetidos.getOrDefault(elemento, 0)+1);}
        
        int respuesta = 0;
        for (int elemento : repetidos.values())
        {if (elemento > 1)
        {respuesta +=1;}}
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	if (minimo >= maximo || cantidad <= 0) {return;}
    	listaEnteros = new ArrayList<>();
